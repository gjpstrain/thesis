...
Data visualisations are a crucial part of making data accessible and interpretable. By leveraging human perceptual and cognitive systems, data visualisations can be designed that communicate information more accurately and efficiently than text and numbers. Despite their ubiquity, unaddressed biases exist which cause viewers to make incorrect judgements about levels of relatedness displayed in positively correlated scatterplots. This thesis investigates this underestimation bias, revealing insights into how changing simple visual features in scatterplots is able to affect perceptions and cognitions about correlations.

The first set of four experiments in this paper explore the effects of changing the opacities and sizes of scatterplot points on participants' estimates of correlation. To summarise, it was found that uniformly reducing the opacity of scatterplot points could increase the correlation underestimation bias, that reducing opacity as a function of residual magnitude could increase estimates of correlation and partially correct for the bias, that reducing size using the same function could correct for the underestimation to a greater degree, and that combining both manipulations produced an overcorrection and consequent overestimation of correlation. The final experiment deviated from this paradigm, investigating whether the effects seen in the previous experiments could be extended into a cognitive space. By contextualising scatterplots as part of news items, evidence was provided that the previously established perceptual effects could also increase the degree to which participants changed their beliefs about a variable pair. Together, these findings provide insights about the nature of correlation estimation, along with implications for designers of scatterplot visualisations.

The work presented here was conducted with a focus on computational reproducibility and open science. This includes open and public sharing of all data and code, and the facilitation of containerised environments to enable computational reproducibility.

The work in this thesis reveals how changing the opacities and sizes of points on scatterplots is able to affect viewer's perceptions of, and beliefs about, the levels of correlation between a pair of variables. These results provide insights into the nature of correlation perception, and provide guidance for those designing with the perception of positive correlation in mind.
\end{abstract}%
\clearpage
...
\chapter{Adjusting the Sizes of Scatterplot Points Can Correct for a Historic Correlation Underestimation Bias}\label{chap:adjusting_size}
