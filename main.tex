...
\makeatletter
\newcommand{\tblscap}[1]{\gdef\@tblscap{#1}}
\newcommand{\@tblscap}{}
...
\wordcount{37,925}		                           % use \wordcount{} to set the count, \thewordcount to print in the text
\maketitle
...
The work presented was conducted with a focus on reproducibility and open science. This includes open and public sharing of all data and code, and the use of containerised environments to enable computational reproducibility.
...
\begin{uomappendix}
	\chapter{Full List of Statements in Chapter \ref{chap:belief_change}} \label{chap:appendix_A}
	\subfile{chapters_tex/chapters_quarto/9_appendix.tex}
\end{uomappendix}
%%%%%%%%%%%%%%%%%% END MATTER %%%%%%%%%%%%%%%%%%
\end{document}