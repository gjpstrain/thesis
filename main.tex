...
\subfile{chapters_tex/chapters_quarto/introduction.tex}\label{chap:introduction}
\chapter{Literature Review}\label{chap:lit_review}
\subfile{chapters_tex/chapters_quarto/literature_review.tex}
\chapter{General Methodology}\label{chap:gen_methods}
\subfile{chapters_tex/chapters_quarto/general_methodology.tex}
\chapter{Adjusting the Opacities of Scatterplot Points Can Affect Correlation Estimates}\label{chap:adjust_opacity}
\subfile{chapters_tex/chapters_quarto/adjusting_opacity.tex}
\chapter{Adjusting the Sizes of Scatterplot Points Can Correct for a Historic Correlation Underestimation Bias}\label{chap:adjust_size}
\subfile{chapters_tex/chapters_quarto/adjusting_size.tex}
\chapter{Interactions of Opacity and Size Adjustments}\label{chap:interactions}
\subfile{chapters_tex/chapters_quarto/interactions_opacity_size.tex}
\chapter{Scatterplots Optimised for Correlation Perception Affect Beliefs About Correlations and Attitudes Towards Trivial Topics}\label{chap:optimise}
\subfile{chapters_tex/chapters_quarto/optimised_scatterplots.tex}
\chapter{Conclusion}\label{chap:conclusion}
\subfile{chapters_tex/chapters_quarto/conclusion.tex}
