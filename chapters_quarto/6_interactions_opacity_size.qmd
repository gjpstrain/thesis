...
#| include: true
#| fig-cap: Examples of the stimuli used in Experiment 4, demonstrated with an \textit{r} value of 0.8.
#| fig-asp: 0.275

examples_congruent <- ggarrange(plot_example_function(slopes,
...
examples_incongruent <- ggarrange(plot_example_function(slopes,
                                                        "Inverted Orientation Size\nTypical Orientation Opacity",
                                                        (1-slopes$slope_inverted),
                                                        (1-slopes$slope_0.25),
                                                        6.25),
