...
inherently require their points to be smaller to prevent obfuscation of the data 
...
and there is evidence that larger stimuli are associated with lower
...
the wider literature described above, two hypotheses are made:
  ...
  smaller as they move further from the regression line, will result in lower
  ...
  points become larger as they get further away from the regression line,
...
[^3], and there were non deviations from them.
