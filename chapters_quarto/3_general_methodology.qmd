...
recently, Bates et al. \cite{bates} have argued that attempting to specify
...
5 features a much simpler modelling siuation, and returns to providing equivalent
Cohen's *d* values, this time calculated using the `effectsize` package \cite{effectsize}.
More details on specific calculations, measures, and conclusions can be found 
*in situ*.
