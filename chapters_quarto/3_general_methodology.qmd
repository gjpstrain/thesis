...
#| include: true
#| tbl-cap: Experimental summary table showing the visual channeln manipulated, the type of manipulation, dependent variable, presence or absence of a baseline condition, experimental design, location, and chapter.
...
values only refer to the plotted scatterplot points; all other visual features,
...
#| label: fig-ink-e3
#| include: true
#| fig-cap: Changes in the total amount of ink in plots in experiment 3 as a function of \textit{r} value, plotted separately for the three size decay conditions and the standard size condition. The influence of point overlap causes the total amount of ink to fall in all conditions bar non-linear decay.
#| fig-asp: 1
