...
In this chapter I describe our research methodologies. The experiments described
...
<!-- we present to be a key contribution of this thesis.[a] -->
...
between-participant designs where each participant only provides a single 
data point. In experiments 1 to 3, each participant saw all experimental stimuli
...
4 featured a factorial 2 $\times$ 2 design; IV1 was the scatterplot point 
opacity design used with 2 levels, and IV2 was the scatterplot point size design 
...
factor, 2 level between-participants design.
...
This was addressed in the pilot study (see Section \ref{pilot}) by preventing participants
...
The first experiment conducted was a pilot study (see Section \ref{pilot} for full details)
...
and aimed to recruit enough participants that the experiments would be adequately
powered \cite{brysbaert_2019}. NB: I did not conduct an *a priori* power analysis.
...
In addition, details about model structures and the issues we tackled
...
ended up being an involved exercise in literate programming (knuth ref) and code wrangling.
...
when carrying out the research. Docker containers
...
Throughout, I havedetailed how I have learnt from my mistakes. Open
...
[b]More about how Docker works would help here
[d]do you talk about your Dockerfiles later? If not, this might be a good 
place to describe how a Dockerfile is constructed, and how yours are built 
- you can explain the critical lines that are common across all your Dockerfiles
