...
plot_example_function <- function (df, t, o, s) {
  ...
  theme(axis.text = element_blank(),
        ...
        plot.title = element_text(size = 8, vjust = -5, hjust = 0.08))
}
```
...
plot_example_function(data_with_resid, t = "", o = 1, s = 0.4)  
```
