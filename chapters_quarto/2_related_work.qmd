...
perceptions of the physical arrangement of scatterplot points, rather than on
any mathematical measure of correlation. This finding received later support
...
bobko_curve <- data.frame(x = c(.87, .64, .5, .35, .19, 0), y = c(.83, .5, .3, .1, .01, 0))
...
and more often rely on misleading mappings.
...
```{r}
#| label: fig-sgl-test-screen
#| include: true
#| fig-cap: Participants were instructed to use the following interface to complete the Subjective Graph Literacy scale \cite{garcia_2016}
#| out-width: NA
#| out-height: NA
