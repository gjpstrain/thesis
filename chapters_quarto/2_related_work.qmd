...
visualisation types had been designed in an effort to better visualise correlation.
...
@fig-other-corr-viz illustrates parallel coordinates plots, along with 7 other
types of correlation visualisation, with an *r* value of 0.8.
