...
Here, Galton is referring to the organs of the body. Measuring a variety of 
anatomical distances, including head lengths and heights of a range of "not
...
did not take place in isolation, however, and the preceding 60 years featured 
...
\cite{lee_1988} based on initial formulae by Bravais (1846) \cite{bravais_1846}.
...
the sum of the product of the difference between each value of $x$ and $x$ is found;
this value represents the degree of deviation of all points from the regression line.
...
Of course, a single value, while mathematically sound, provides no information about
...
The need for visualisation is most 
