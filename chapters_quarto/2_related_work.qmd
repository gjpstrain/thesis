...
of the semi-interquartile ranges of two variables. @fig-galston-hand-plot contains
a negative scan of Galston's original plot, along with a modern recreation using 
``ggplot2``.
