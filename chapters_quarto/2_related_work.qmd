...
experiments that aim to investigate cognition require more complicated
...
as_tibble(my_rs) %>%
  ...
  mutate(under_est_collyer = (1.4118*my_rs) - .063) %>%
  ggplot() +
...
experimental chapter. \chap{chap:conclusion} includes figures detailing 
the underestimation observed throughout this thesis in comparison to previous
work. Despite this long-standing finding, no efforts have been made to correct
...
visualisation entered the public conscience for many. @fig-covid-viz includes
...
recognise and account for the differences in ability in lay populations. Research
...
the following contributions:
  ...
  3. These effects do extent into a cognitive space, and are able to influence 
