...
of the semi-interquartile ranges of two variables. I have recreated the plot using
`ggplot` in @fig-galston-hand-plot

```{r}
#| label: fig-galston-hand-plot
#| include: true
#| fig-cap: placeholder
#| fig-asp: 1
...
ggplot(data, aes(stature, cubit)) +
  ...
  annotate("text", x = -0.25, y = 0.45, angle = 45, label = "Line of Q1 values", size = 7) +
    annotate("text", x = 0.35, y = -0.35, angle = 45, label = "Line of Q3 values", size = 7)
```
