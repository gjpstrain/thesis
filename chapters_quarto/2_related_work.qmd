...
While the evidence for this link is controversial, the existence of such
...
limited evidence of prehistoric cartographic drawings \cite{muhly_1978}, which may also be considered
...
equivalent to data visualisation, the existence of these representations emphasises the 
...
\cite{friendly_2008} sees the rise of forms of data visualisation that begin 
...
largely caused that attrition. In Florence Nightingale's polar area chart depicting
...
case, visualisation is used effectively appeal to our affinity for visual
storytelling.
...
would only accelerate through the next century. The most prominent example of this
...
of which are now commonplace in software packages and statistics education. Jacques
Bertin, in 1967 \cite{bertin_1967} published *Sémiologie graphique* 
...
which in turn influenced the `ggplot2` package \cite{hadley_2016} that is used
