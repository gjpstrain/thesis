...
the sum of the products of the difference between each value of $x$ and $y$ is found;
...
Despite the importance of graphics like these for Francis Galton's discovery of
...
can be found in much earlier work on the orbits of twin starts by John F. W. 
...
and data of observation ($x$), and grid lines, Herschel then describes plotting points and drawing,
...
by Ejnar Hertzprung and Henry Norris Russell in 1911-1913 \cite{montmerle_2011}.
...
a crucial part of the visualisers toolbox. From its origins as a way of inferring
...
lab mate to those able to use graphing to solve scientific problems.
