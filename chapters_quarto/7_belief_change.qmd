...
#| include: true
#| fig-cap: Examples of the experimental stimuli for Experiment 5 using an \textit{r} value of 0.6. Group A saw the alternative scatterplot presented on the left, while group B saw the standard design on the right. The labels below the plots are included for the reader's convenience, and were not a part of the experimental stimuli. 
#| fig-asp: 0.7
