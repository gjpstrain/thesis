...
specified employs that modality's non-linear decay function. The present experiment
investigates the potential for alternative scatterplot designs to have effects on
cognition. For this reason, and to facilitate comparison to the work found
...
instructions for building a Docker container to recreate the computation
...
myself a co-author in Section \ref{beliefs-e5a}. We agreed above chance for both
...
Each participant saw all 25 survey items (see Appendix A), along with the six
