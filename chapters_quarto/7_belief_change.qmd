...
The pre-study featured a within-subjects design. Each participant saw all experimental
...
and strength of relatedness. Stimuli were presented in a randomised order, with 6
...
#| include: true
#| fig-cap: Examples of the stimuli for Experiment 5 using \textit{r} values of 0.2, 0.6, and 0.99. Group A saw the alternative scatterplot presented on the left, while group B saw the standard design on the right. Plots in the alternative condition (left) used the combined point opacity and size decay functions developed in \chap{chap:interactions_opacity_size} (see the "Both Manipulations" panel in @fig-previous-manipulations). 
#| fig-asp: 1.5
#| out-width: "100%"
...
(see @fig-exp5-examples-chap7). Further tuning of these decay functions, with
