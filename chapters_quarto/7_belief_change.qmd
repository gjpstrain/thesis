...
employing point opacity and size manipulations described in Section \ref{related-work-beliefs}
...
linear mixed effects models. This was an oversight; conclusions are identical when using said models.
...
An alternative (although not competing) explanation for the results have seen here
comes from recent work on the incorporation of uncertainty visualisations in scatterplots.
Karduni et al. \cite{karduni_2020} found in 2020 that visualisations that encode uncertainty
...
and only one of the alternative scatterplot visualisations described in this thesis
