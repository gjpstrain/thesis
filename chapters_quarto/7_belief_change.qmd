...
in highly accurate correlation estimates (see Figure \ref{fig-estimates-by-r-e3}, \chap{chap:adjusting_size). In \chap{chap:interactions_opacity_size},
...
Research consistently finds that the correlation displayed in positively correlated scatterplots is underestimated \cite{strahan_1978,bobko_1979, cleveland_1982,
...
but also effects understanding about how these designs might be used by
...
affected by prior beliefs and attitudes \cite{matejka_2015, xiong_2023}, and that
...
The pre-study featured a within-subjects design. Each participant saw all 25 survey items (see Appendix A), along with the six
...
anova_results(e5_rating_time_model, e5_rating_time_model_cmpr)
```
...
anova_results(e5_condition_interact_model, e5_condition_interact_model_cmpr)
```
...
to *and* the time they made the rating. A likelihood ratio test revealed that
...
and statement emotional valence in Section \ref{add-analyses-discussion}.
