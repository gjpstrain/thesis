...
largest effect size observed (*d* ~ 0.16) is between thelow and full opacity
...
correlation change with the objective *r* value in the plot. As reported in
previous literature (see Sec in related work), participants underestimated
*r* in nearly all cases (revise).
