...
four scatterplots depicting correlations of *r* = 0.2, 0.5, 0.8, and 0.99
(see @fig-training-slide-adjusting-opacity) to familiarise themselves with the concept.
To test if the patterns of results seen in correlation estimation could be attribute
...
to the origin revealed a significant effect in experiment 1 ($\chi^2$(`r in_paren(e1_training_model.df)`) =
