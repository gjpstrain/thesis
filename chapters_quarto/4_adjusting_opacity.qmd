...
`r printnum(E1_uniform_adjustments_tidy_graph_literacy$sd, digits = 1)`). The mean time
...
`r printnum(E2_spatially_dependent_tidy_graph_literacy$sd, digits = 1)`). The mean time
taken to complete the experiment was 33 minutes (SD = 10 minutes).
