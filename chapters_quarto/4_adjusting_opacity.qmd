...
Section \ref{graph-literacy-lit-review} of the related work chapter. Early piloting
...
visualisation techniques that have a basis in the literature. Chapter 5 investigates 
the use of point size in place of opacity with the techniques described, while
Chapter 6 combines the two to explore how these different modalities work
