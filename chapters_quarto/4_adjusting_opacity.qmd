...
in the plot seen on the left in @fig-pilot-study-examples.
...
@fig-opposing-curve) to relate point opacity to residuals. An minimum alpha value of 0.025
...
The most exciting avenue for related future work is expanding the technique
