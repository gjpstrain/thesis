...
designing and analysing the experiments described here, however see \ref{ink} for
...
using equation 4.1. Examples of the stimuli used in experiment 2 can be seen in
...
Due to alpha values being hard coded to residual magnitudes, the full range of opacities
is not always accessed depending on the *r* value and the particular condition.
To illustrate this,
Figure \ref{fig-opposing-curve} demonstrates the relationships between residual
