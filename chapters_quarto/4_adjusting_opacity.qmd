...
Figure \ref{fig-opposing-curve} demonstrates the relationship between residual
magnitude and opacity value in each of these condition types using an *r* 
value of 0.6.
...
ggarrange(plot_example_function(slopes, "Full Opacity",
                                1, 0.2, 6.5),
          plot_example_function(slopes, "Linear Decay",
                                (1-slopes$slope_linear), 0.2, 6.5),
          plot_example_function(slopes, "Non-linear Decay",
                                (1-slopes$slope_0.25), 0.2, 6.5),
          plot_example_function(slopes, "Inverted Non-linear Decay",
                                (1-slopes$slope_inverted), 0.2, 6.5),
          nrow = 1)
```
