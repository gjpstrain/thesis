...
size and opacity decrease, however, individual point salience decreases,
leading designers to be forced to consider a trade-off between
accurately representing the whole dataset and allowing for individual
data points to be effectively accessible to viewers
