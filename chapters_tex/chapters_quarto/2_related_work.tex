...
hand-drawn plots of the semi-interquartile ranges of two variables. I
have recreated the plot using \texttt{ggplot} in
Figure~\ref{fig-galston-hand-plot}

\begin{figure}

\centering{

\includegraphics[width=\textwidth]{2_related_work_files/figure-latex/fig-galston-hand-plot-1.pdf}

}

\caption{\label{fig-galston-hand-plot}placeholder}
