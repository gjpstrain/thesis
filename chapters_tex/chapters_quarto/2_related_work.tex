...
\item
  Can these changes be used to correct for a historical underestimation
  bias?
\item
...
\item
  These effects can be used to correct for the historical
  underestimation bias without removing data, although significantly
  more work is needed to find the exact combinations of size and opacity
  adjustments that produce perceptually-optimised estimates.
\item
