...
test portion of each experiment is shown in \textbf{?@fig-sgl-screen}.
...
\caption{\label{fig-sgl-test-screen}Participants were instructed to use
the following interface to complete the Subjective Graph Literacy scale
\cite{garcia_2016}}
