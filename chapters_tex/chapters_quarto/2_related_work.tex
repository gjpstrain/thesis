...
focus on four higher level tasks for the remainder of this section:
...
Figure~\ref{fig-task-examples} illustrates these four tasks using
scatterplots of the type used in the experiments throughout this thesis.
...
scatterplots tasks using scatterplots similar to those used in the
...
opacity of points are common methods of ameliorating these issues. As
point size and opacity decrease, however, individual point salience
...
individual data points to be accessible to viewers
