...
rankings as they pertain to correlation perception and scatterplot tasks
more generally, before providing an overview of clutter and overplotting
issues, especially as they pertain to the techniques developed in this
thesis. Finally, I discuss scatterplots specifically as they pertain to
correlation perception.

\subsection{Scatterplot Tasks \& Visual
Channels}\label{scatterplot-tasks}
...
\cite{quadri_2021} provide a task-based overview of visualisations,
...
analysis tasks are split into 3 types: \emph{object-centre} tasks, such
as value retrieval and comparison between data points; \emph{browsing}
tasks, such as finding clusters; and \emph{aggregate-level} tasks, such
as determining correlations or anomalies. Kanjanabose et
al.~\cite{kanjanabose_2015} used a set of four tasks (value retrieval,
clustering, outlier detection, and change detection) when comparing task
performance between scatterplots and parallel coordinates plots, and
Wang et al.~\cite{wang_2021} used three (finding anomalies, judging
correlation, and identifying clusters) when studying data size and
pattern salience with regards to scatterplot comprehension. Lee et
al.~\cite{lee_2017}, in development of the Visualisation Literacy
Assessment Test (VLAT), identify scatterplots as being uniquely suitable
for the eight visualisation tasks chosen (retrieve value, find extremum,
determine range, characterise distribution, find anomalies, find
trends/correlations, and make comparisons). Within a particular study or
taxonomy, many tasks overlap with regards to what viewers of
visualisations actually do. Hence, I focus on four higher level tasks
...
128-point scatterplots of the type used in the experiments throughout
this thesis.
...
\caption{\label{fig-task-examples}placeholder}
...
Sarikaya \& Gleicher, 2017 Kanjanabose et al., 2015 Wang et al., 2021
