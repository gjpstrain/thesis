...
\ref{introduction-adjusting-size}) encode an additional third variable
using point size. Aside from information overload, there is no hard
limit to the number of variables that a scatterplot might encode,
...
\ref{present-landscape-corr-viz} displays examples of other types of
...
\chap{chap:gen_methods} contains a more comprehensive discussion of the
impact of overplotting throughout this thesis, including visualisations
that describe how much \emph{ink} was actually present in experimental
scatterplots once overlap had been taken into account.
