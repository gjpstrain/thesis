...
This figure is taken from Friendly (2008) \cite{friendly_2008b}.}
...
\caption{\label{fig-task-examples}Illustrating four different
scatterplot tasks using scatterplots similar to those used in the
experiments in this thesis. Visual elements are used to highlight the
task detailed in the title of each plot.}
