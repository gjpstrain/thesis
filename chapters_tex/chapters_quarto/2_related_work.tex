...
between two variables \cite{kay_2016}. Figure~\ref{fig-other-corr-viz}
...
distribution, find anomalies, find trends/correlations, and make
comparisons). Within a particular study or taxonomy, many tasks overlap
with regards to what viewers of visualisations actually do. Hence, I
focus on four higher level tasks, illustrated in
...
the data. The value retrieval task usually required viewers to use axis
...
\item
  Can these changes be used to correct for the underestimation bias?
\item
