...
\caption{\label{fig-e5-trial-example}An example of an experimental trial
in the pre-test, including the text stimulus participants were asked to
read, and the Likert scales they were asked to use to indicate their
beliefs about topic emotionality and strength of relatedness.}
...
\caption{\label{fig-all-statements-results}Dot plots showing average
...
\caption{\label{fig-exp5-examples-chap7}Examples of the stimuli for
...
\caption{\label{fig-descriptives-e5}Dot plots showing individual pre-
and post-plot viewing ratings of strength of relatedness for standard
and alternative scatterplot conditions. Mean ratings are also shown as
points.}
...
Difference is calculated by subtracting the ratings made before viewing
plots from the ratings made after. Median values are plotted as points.}
