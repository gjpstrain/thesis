...
\pandocbounded{\includegraphics[keepaspectratio]{7_belief_change_files/figure-latex/fig-previous-manipulations-1.pdf}}
...
perceptual effects on participants and their performance.
...
my own. To control for these factors as much as possible, the pre-study
...
statements shown in Table~\ref{tbl-all-statements}, and to indicate
their beliefs about topic emotionality and strength of relatedness.
Stimuli were presented in a randomised order, with 6 attention checks
...
\pandocbounded{\includegraphics[keepaspectratio]{../supplied_graphics/e5_pre_test_trial.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{7_belief_change_files/figure-latex/fig-all-statements-results-1.pdf}}
...
these factors can be found in Section \ref{add-analyses-e5}.
...
\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{7_belief_change_files/figure-latex/fig-exp5-examples-chap7-1.pdf}
...
standard design on the right. Plots in the alternative condition (left)
used the combined point opacity and size decay functions developed in
\chap{chap:interactions_opacity_size} (see the ``Both Manipulations''
panel in Figure~\ref{fig-previous-manipulations}).}
...
\pandocbounded{\includegraphics[keepaspectratio]{7_belief_change_files/figure-latex/fig-exp5-examples-chap7-cont-1.pdf}}
...
described previously. After completing 45 experimental trials,
...
\pandocbounded{\includegraphics[keepaspectratio]{../supplied_graphics/exp5_flowchart.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{7_belief_change_files/figure-latex/fig-descriptives-e5-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{7_belief_change_files/figure-latex/fig-difference-descriptive-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{7_belief_change_files/figure-latex/fig-add-analyses-plots-1.pdf}}
...
Figure~\ref{fig-exp5-examples-chap7}). Further tuning of these decay
