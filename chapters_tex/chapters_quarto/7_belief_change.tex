...
\caption[Dot plots showing average ratings of strength of relatedness
and emotionality across the 25 tested statements in the Experiment 5
pre-test.]{\label{fig-all-statements-results}Dot plots showing average
...
non-binary). Participants' mean age was 39.3 (SD = 11.5). Participants'
mean graph literacy score was 21.3 (SD = 4.3) out of 30, their mean
defensive confidence score was 43 (SD = 6.8) out of 60, and their mean
rating of statement emotional valence was 2.9 (SD = 1.3) on a 7-point
Likert scale. On average, participants took 14.2 minutes to complete the
experiment (SD = 6.41).
