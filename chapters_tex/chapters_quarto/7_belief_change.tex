...
@ fig-previous-manipulations contains a summary of the most promising
point opacity and size manipulations from the previous three chapters in
this thesis, along with their effects on performance on a correlation
estimation task.
