...
analysis (48\% male, 50 \% female, and 2\% non-binary). Participants'
mean age was 29.56 (\emph{SD} = 8.54). Mean graph literacy score was
21.77 (\emph{SD} = 4.29). The average time taken to complete the
