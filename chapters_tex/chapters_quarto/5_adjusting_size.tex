...
biased upwards to correct for the historic underestimation bias to a
...
engine are encoded with point size. We can see from this plot that
vehicles with higher engine displacement and lower fuel efficiency tend
to have a higher number of engine cylinders.}
...
in scatterplots had taken place. Those that were completed found bias
and variability in correlation perception performance invariant to
changes in point size \cite{rensink_2012, rensink_2014}, however these
studies were low-powered considering the small effect sizes found in the
experiments described in \chap{chap:adjusting_opacity}. From the wider
literature, there is evidence that larger points in scatterplots can
bias judgements of mean point position to a greater degree than point
opacity can \cite{hong_2022}, in what is termed the \emph{weighted
average illusion}. Outside of scatterplots and scatterplot-adjacent
chart types, there is evidence that increased size can result in faster
reaction times to peripherally presented stimuli \cite{grice_1983}, and
there is evidence that larger stimuli are associated with lower levels
of spatial certainty \cite{alais_2004} but higher levels of salience
...
present experiment having a width of 12 pixels on a 1920 \(\times\) 1080
pixel monitor, which is consistent with the point size used in the
experiments described in \chap{chap:adjusting_opacity}. Examples of the
stimuli used in this experiment can be see in
...
participant saw and responding to each of the 180 scatterplots in a
fully randomised order. There were four scatterplots for each of the 45
...
encoding channel for the manipulation of perceived contrast than point
opacity. If these effects are being driven by the lower salience of more
external points, the fact that a larger effect of point size has been
reported is congruent with research showing clear influences of stimulus
size on object salience and perceptual weighting
...
responsible for the effects have seen here; investigating this is beyond
the scope of the current study and does not negate the findings. There
is also the potential for misinterpretation of the scatterplots
presented in the current study, especially given their similarity in
...
using a non-linear equation not only producing significantly more
