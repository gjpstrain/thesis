...
weighting and spatial uncertainty as potential drivers for the effects
...
\ref{fig-exp2-examples-chap4} on \pageref{fig-exp2-examples-chap4}).
That this technique has been shown to produce more accurate correlation
estimates compared to unadjusted scatterplots may explain why the
...
had particularly low opacity. All stimuli in the current experiment use
a combination of the non-linear decay and inverted non-linear decay
