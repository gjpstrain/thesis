...
\chap{adjusting_opacity} found clear, if small, effects. That work
...
is associated with lower salience \cite{healey_2011}, can bias
judgements of mean point position \cite{hong_2021}, increases error in
...
\cite{healey_2011}, results which are supported by evidence that
...
towards areas that contain larger points \cite{hong_2021}. These
...
in previous work \cite{hong_2021}, that size is a more potent encoding
