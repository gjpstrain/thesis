...
\caption{\label{fig-e4-estimates}Estimated marginal means of error for
the four conditions tested in Experiment 4. 95\% confidence intervals
are shown. The vertical dashed line represents no estimation error.}
