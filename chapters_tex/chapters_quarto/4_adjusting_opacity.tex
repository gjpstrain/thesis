...
\midrule
Low Opacity
(alpha = 0.25) & Medium Opacity
(alpha = 0.5) & 6.631 & <0.001\\
Low Opacity
(alpha = 0.25) & High Opacity
(alpha = 0.75) & 12.071 & <0.001\\
Low Opacity
(alpha = 0.25) & Full Opacity
(alpha = 1.0) & 13.439 & <0.001\\
Medium Opacity
(alpha = 0.5) & High Opacity
(alpha = 0.75) & 5.443 & <0.001\\
Medium Opacity
(alpha = 0.5) & Full Opacity
(alpha = 1.0) & 6.809 & <0.001\\
\addlinespace
High Opacity
(alpha = 0.75) & Full Opacity
(alpha = 1.0) & 1.363 & 0.523\\
\bottomrule
\end{tabular}
...
model, but also includes graph literacy as a fixed effect. There was no
effect of graph literacy, indicating that the differences observed in
participants' correlation estimation performance were not as a result of
their differing levels of graph literacy (\(\chi^2\)(1) = .002, \emph{p}
= .962).

\begin{table}

\caption{\label{tbl-sig-e1}placeholder}

\centering{

\begin{tabular}[t]{lrrrrlrr}
\toprule
  & Estimate & Standard Error & df & t-value & Pr(>|t|) & Odds Ratio & Cohen's \textbackslash{}\textbackslash{}textit\{d\}\\
\midrule
Low Opacity (alpha = 0.25) & 0.181 & 0.048 & 168.1 & 3.75 & <0.001 & 1.198 & 0.100\\
Medium Opacity (alpha = 0.5) & -0.017 & 0.003 & 26637.0 & -6.63 & <0.001 & 0.984 & -0.009\\
High Opacity (alpha = 0.75) & -0.030 & 0.003 & 26637.0 & -12.07 & <0.001 & 0.970 & -0.017\\
Full Opacity (alpha = 1.0) & -0.034 & 0.003 & 26637.0 & -13.44 & <0.001 & 0.967 & -0.019\\
Graph Literacy & 0.000 & 0.002 & 148.0 & 0.05 & 0.962 & 1.000 & 0.000\\
\bottomrule
\end{tabular}
