...
\caption{\label{fig-e1-estimates}Estimated marginal means of error for
the four conditions tested in Experiment 1. 95\% confidence intervals
are shown. The vertical dashed line represents no estimation error. The
...
\caption{\label{fig-opposing-curve}Using \textit{r} values of 0.2, 0.6,
and 0.9 to demonstrate the relationship between the size of a point's
residual and the alpha value (opacity) rendered. Note that as the
\textit{r} value increases, the range of alpha values that can be
...
\caption{\label{fig-e2-estimates}Estimated marginal means of error for
the four conditions tested in Experiment 2. 95\% confidence intervals
are shown. The vertical dashed line represents no estimation error. The
overestimation zone is included to facilitate comparison to later work.}
