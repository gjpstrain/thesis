...
correlation estimation error for plot size and the presence of the
...
factor and opacity decay factor.}
...
demonstrated with an \emph{r} value of 0.8.
...
Experiment 1, demonstrated with an \textit{r} value of 0.8. Here,
...
\caption{\label{tbl-efs-e1}Cohen's \textit{d} effect sizes and summary
statistics for levels of the opacity factor in Experiment 1. Each effect
size is compared to the reference level, full contrast (alpha = 1).}
...
demonstrated with an \emph{r} value of 0.8. Given the shape of the
...
Experiment 2, demonstrated with an \textit{r} value of 0.8. Here,
``opacity'' refers to the alpha value used by ggplot.}
...
\caption{\label{tbl-efs-e2}Cohen's \textit{d} effect sizes and summary
statistics for the opacity decay function factor in Experiment 2. Each
effect size is compared to the reference level, full contrast (alpha =
1).}
...
ellipse over a scatterplot with an \textit{r} value of 0.8.}
