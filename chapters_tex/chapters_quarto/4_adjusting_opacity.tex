...
the full analysis (77.00 male, 71 female, and 2 non-binary).
Participants' mean age was 28.3 (\emph{SD} = 8.6). Mean graph literacy
score was 21.8 (\emph{SD} = 4.5). The mean time taken to complete the
