...
Figure~\ref{fig-estimates-by-r} illustrates the effects of each
...
\includegraphics[width=\textwidth]{4_adjusting_opacity_files/figure-latex/fig-estimates-by-r-1.pdf}

}

\caption{\label{fig-estimates-by-r}Participants' mean errors in
