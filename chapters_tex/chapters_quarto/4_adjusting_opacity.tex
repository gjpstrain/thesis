...
items, corresponding to \textasciitilde27,000 individual judgements per
...
stimulus opacity on perception described in Section
\ref{related-work-adjusting-opacity}
...
largest effect size observed (\emph{d} \textasciitilde{} 0.16) is
...
line shows mean errors in correlation estimation, and standard
...
decay condition (\textasciitilde0.19) is small.
