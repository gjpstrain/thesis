...
however the implementation of this condition was immature. Throughout
this thesis, \textbf{decay} refers to the way in which the opacity or
size of a point is changed according to its distance from the regression
line; a \textbf{decay function} refers, therefore, to the mathematical
relationship between a point's opacity or size and its residual
magnitude.
