...
had the lowest possible opacity, and vice versa, resulting in the plot
seen on the left in Figure~\ref{fig-pilot-study-examples}.
...
\tightlist
\item
  H1: A greater spread of estimates of correlation, measured by standard
  deviations, for plots with lower global opacity compared to higher
  opacity plots will be observed.
\end{itemize}
...
\item
  ...
  opacity becomes greater with residual magnitude, will result in higher
...
Figure~\ref{fig-opposing-curve}) to relate point opacity to residuals.
An minimum alpha value of 0.025 was used to ensure that all points were
...
technique developed here to other visual features in isolation and
