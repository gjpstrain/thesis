...
\section{Shared Methods}\label{shared-methods-adjusting-opacity}
...
that was displayed for 2.5 seconds.
...
analysis (51.01\% male, 47.65 \% female, and 1.34\% non-binary).
Participants' mean age was 28.29 (\emph{SD} = 8.59). Mean graph literacy
score was 21.76 (\emph{SD} = 4.47). The average time taken to complete
