...
\subsection{Method}\label{methods-e1}
...
between thelow and full opacity conditions, and is small. This was
...
correlation change with the objective \emph{r} value in the plot. As
reported in previous literature (see Sec in related work), participants
underestimated \emph{r} in nearly all cases (revise).
...
\subsection{Methods}\label{methods-e2}
