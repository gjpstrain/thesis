...
adoption of wearable devices, which by their nature result in users
viewing visualisations of a range of sizes \cite{shandhi_2024}. The
first experiment conducted therefore examined how perceptions of
correlation changed according to the size of a scatterplot.
Additionally, a very early version of the opacity decay condition from
Experiment 2 was included, however the implementation of this condition
was immature. Throughout this thesis, \textbf{decay} refers to the way
in which the opacity or size of a point is changed according to its
distance from the regression line; a \textbf{decay function} refers,
therefore, to the mathematical relationship between a point's opacity or
size and its residual magnitude.
...
(\emph{SD} = 4.5). The mean time taken to complete the experiment was 33
...
graph literacy score was 21.7 (\emph{SD} = 4.1). The mean time taken to
