...
participants' estimates of correlation would exhibit lower mean error
with a decay parameter in which point opacity falls with residual
distance in a non-linear fashion, and that
