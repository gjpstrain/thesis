...
experiments described here, however see \ref{ink} for plots visualising
the impacts of point overlap throughout this thesis. Due to this, the
approach to opacity described in this chapter would not be useful when
dealing with much larger datasets where clutter becomes an issue.
...
residual magnitude using equation 4.1. Examples of the stimuli used in
experiment 2 can be seen in Figure~\ref{fig-exp2-examples-chap4}.
...
magnitude. Due to alpha values being hard coded to residual magnitudes,
the full range of opacities is not always accessed depending on the
\emph{r} value and the particular condition. To illustrate this, Figure
\ref{fig-opposing-curve} demonstrates the relationships between residual
magnitudes and opacity values in each condition using \emph{r} values of
0.2, 0.6, and 0.99.
