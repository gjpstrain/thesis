...
\caption{\label{fig-exp-illustrate}An example of an experimental trial
in Experiments 1-4, including the scatterplot stimulus (A), the slider
that participants were instructed to use to estimate correlation (B),
and the trial counter (C).}
...
\caption{\label{fig-exp5-examples}Examples of the stimuli for Experiment
5 using \textit{r} values of 0.2, 0.6, and 0.99. Group A saw the
...
\caption{\label{fig-ink-e1}Changes in the total amount of ink in plots
in experiment 1 as a function of \textit{r} value, plotted separately
for the four global opacity conditions. Note how in each condition, the
total amount of ink begins to drop very slightly as the objective
\textit{r} value increases.}
...
\caption{\label{fig-ink-e2}Changes in the total amount of ink in plots
in experiment 2 as a function of \textit{r} value, plotted separately
for the three opacity decay conditions and the full opacity condition.}
...
\caption{\label{fig-ink-e3}Changes in the total amount of ink in plots
in experiment 3 as a function of \textit{r} value, plotted separately
for the three size decay conditions and the standard size condition. The
influence of point overlap causes the total amount of ink to fall in all
conditions, with non-linear decay experiencing some rise in total ink
prior.}
...
\caption{\label{fig-ink-e4}Changes in the total amount of ink in plots
in experiment 4 as a function of \textit{r} value, plotted separately
for the four opacity and size decay conditions.}
...
\caption{\label{fig-ink-e5}Changes in the total amount of ink in plots
in experiment 5 as a function of \textit{r} value, plotted separately
for standard and alternative plotting conditions. Only the scatterplot
points themselves are included in these calculations.}
