...
dataset are dropped; this stepwise elimination of terms is evaluated
using successive likelihood ratio tests. This results in a model that
captures the maximal amount of feasible variability while minimising
redundancy. Note that \texttt{buildmer} was not relied upon as a
modelling \emph{panacea}; models are still based on theoretical
