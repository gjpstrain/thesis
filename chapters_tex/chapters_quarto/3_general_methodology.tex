...
\subsection{A Note on Ink}\label{a-note-on-ink}
...
for the four opacity decay conditions.}
...
for the four size decay conditions.}
...
however to facilitate comparison, it was decided that \emph{N} = 150
would remain the target recruitment rate.
