...
visual channeln manipulated, the type of manipulation, dependent
variable, presence or absence of a baseline condition, experimental
design, location, and chapter.}
...
the plotted scatterplot points; all other visual features, including
axis lines and ticks, in experiments 1 to 4, and text in experiment 5,
are discounted. Each visualisation shows the normalised total ink
...
conditions bar non-linear decay.}
...
analysis. Below is a minimal example of a Dockerfile.

I first specify the Rocker image that will form the basis of the
container. This includes the version of R required (version 4.5.1), the
Rstudio Integrated Development Environment (IDE), Quarto, and the
\texttt{tidyverse} package.

\texttt{FROM\ rocker/version:4.5.1}
...
\texttt{ADD\ thesis.bib\ /home/rstudio/}

\texttt{ADD\ reformat\_tex.R\ /home/rstudio/}
...
\texttt{RUN\ R\ -e\ "devtools::install\_version(\textquotesingle{}MASS\textquotesingle{},\ version\ =\ \textquotesingle{}7.3-65\textquotesingle{},\ dependencies\ =\ T)"}

\texttt{RUN\ R\ -e\ "devtools::install\_version(\textquotesingle{}ggdist\textquotesingle{},\ version\ =\ \textquotesingle{}3.3.3\textquotesingle{},\ dependencies\ =\ T)"}

\texttt{RUN\ R\ -e\ "devtools::install\_version(\textquotesingle{}ggpubr\textquotesingle{},\ version\ =\ \textquotesingle{}0.6.1\textquotesingle{},\ dependencies\ =\ T)"}
