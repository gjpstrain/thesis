...
Experiment 2, demonstrated with an \textit{r} value of 0.8.}
...
scatterplot presented on the right, while group B saw the typical design
on the left.}
...
\url{https://gitlab.pavlovia.org/Strain/exp_size_only}
