...
Figure~\ref{fig-ink-e4}, and for experiment 5 in \textbf{?@fig-ink-e5}.
In all cases, total ink values only refer to the plotted scatterplot
points; all other visual features, including axis lines and ticks, in
