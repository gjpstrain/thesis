...
\includegraphics[width=1\textwidth,height=\textheight]{3_general_methodology_files/figure-latex/fig-mixed-effects-demo-1.pdf}
...
item. More recently, Bates et al.~\cite{bates} have argued that
...
Experiment 5 features a much simpler modelling siuation, and returns to
providing equivalent Cohen's \emph{d} values, this time calculated using
the \texttt{effectsize} package \cite{effectsize}. More details on
specific calculations, measures, and conclusions can be found \emph{in
situ}.
