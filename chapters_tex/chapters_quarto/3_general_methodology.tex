...
on the external constraints imposed on the research team. Concerns such
as time, practicality, and cost must be addressed, and a compromise
between research that is \emph{valuable} and research that is
...
experiment items in levels \cite{charness_2012}, offer a significant
...
designed to ellict greater levels of belief change compared to typical
...
\includegraphics{3_general_methodology_files/figure-latex/fig-exp1-examples-1.pdf}
...
\includegraphics{3_general_methodology_files/figure-latex/fig-exp2-examples-1.pdf}
...
\includegraphics{3_general_methodology_files/figure-latex/fig-exp3-examples-1.pdf}
...
\includegraphics{3_general_methodology_files/figure-latex/fig-exp4-examples-1.pdf}
...
\includegraphics{3_general_methodology_files/figure-latex/fig-exp5-examples-1.pdf}
...
there is no theoretical reason to back this assumption. Metric modelling
