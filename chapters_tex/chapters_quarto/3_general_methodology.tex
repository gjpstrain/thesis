...
\caption{\label{fig-exp1-examples}placeholder}
...
container. This includes the version of R required (version 4.4.1), the
Rstudio Integrated Development Environment (IDE), Quarto, and the
\texttt{tidyverse} package.

\texttt{FROM\ rocker/version:4.4.1}
...
be found throughout. I favour permissive and lenient licencing, such as
the MIT licence \cite{mit} for GitHub repositories and the CC-BY 4.0
...
following publication of the corresponding research. Deviations from
registered analysis plans are detailed in the methods sections of the
